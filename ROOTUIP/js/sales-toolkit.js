...
class SalesToolkit {
    ...
    downloadDocument(docId) {
        ...
        // Create a temporary element to convert HTML to downloadable format
        const tempDiv = document.createElement('div');
        tempDiv.innerHTML = doc.content;
        
        // Convert to text for simple download (in production, would generate PDF)
